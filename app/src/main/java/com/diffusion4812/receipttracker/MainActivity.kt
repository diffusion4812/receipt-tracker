...
import com.diffusion4812.receipttracker.ui.CameraPreviewViewModel
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            ReceiptTrackerTheme {
                ReceiptTrackerNavHost(navController)
            }
        }
    }
}
...
fun ReceiptTrackerNavHost(
    ...
    NavHost(navController = navController, startDestination = "home") { // add NavHost here
        composable("home") {
            ReceiptTrackerHomeScreen(navController, modifier = Modifier)
        }
        composable("camera") {
            CameraPreviewScreen(
                modifier = Modifier,
